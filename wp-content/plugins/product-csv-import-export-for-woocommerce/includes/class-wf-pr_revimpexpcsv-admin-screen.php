...
class WF_ProdReviewImpExpCsv_Admin_Screen {
    ...
    public function admin_scripts() {
        ...
        if (in_array($screen->id, $allowed_creen_id)) {
            ...
            wp_enqueue_script('woocommerce-product-csv-importer2', plugins_url(basename(plugin_dir_path(WF_PrRevImpExpCsv_FILE)) . '/js/product-rev-csv-import-export-for-woocommerce.min.js?fds', basename(__FILE__)), '', '1.0.0', 'screen');
