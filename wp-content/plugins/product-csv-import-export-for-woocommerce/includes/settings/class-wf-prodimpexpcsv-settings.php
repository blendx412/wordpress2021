...
class WF_ProdImpExpCsv_Settings {
    ...
    public static function save_settings() {
        ...
        $pro_auto_export_prod_status= !empty($_POST['pro_auto_export_prod_status']) ? $_POST['pro_auto_export_prod_status'] : null;
        ...
        $pro_auto_import_url_new_prod_status = !empty($_POST['pro_auto_import_url_new_prod_status']) ? $_POST['pro_auto_import_url_new_prod_status'] : null;
