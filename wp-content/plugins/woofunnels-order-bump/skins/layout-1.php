...
if ( '' !== $cart_item_key ) {
	$price_data = WFOB_Common::get_cart_product_price_data( $wc_product, $cart_item );
} else {
                ...
                <div class="wfob_Box">
                                ...
                                <div class="wfob_bgBox_table_box">
                                    <div class="wfob_bgBox_cell wfob_img_box">
                                        <div class="wfob_checkbox_input_wrap">
											...
											if ( wc_string_to_bool( $design_data['header_enable_pointing_arrow'] ) ) {
												...
												?>
                                                <span><img src="<?php echo $blink_url; ?>"></span>
												<?php
											}
											?>
                                    ...
                                    <div class="wfob_bgBox_cell">
                                        <div class="wfob_content_sec <?php echo $enable_pointer; ?>">
                                            <label for="<?php echo $product_key; ?>" class="wfob_title wfob_bgBox_cell"> <?php echo WFOB_Common::decode_merge_tags( $product_title, $price_data, $wc_product, $data, $cart_item, $cart_item_key ); ?> </label>
											<?php
                    ...
                    <div class="wfob_contentBox wfob_clear">
                        ...
                        <div class="wfob_pro_txt_wrap">
                            <p><?php
								echo WFOB_Common::decode_merge_tags( $description, $price_data, $wc_product, $data, $cart_item, $cart_item_key ); ?> </p>
							<?php

							if ( isset( $data['variable'] ) ) {

								printf( "<a href='#' class='wfob_qv-button var_product' qv-id='%d' qv-var-id='%d'>%s</a>", $data['id'], $cart_variation_id, __( 'Choose an option', 'woocommerce' ) );
							}
							?>
                        </div>
                    </div>
