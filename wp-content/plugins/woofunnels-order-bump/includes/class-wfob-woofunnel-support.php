...
class WFOB_WooFunnels_Support {
	...
	public function __construct() {
		...
		if ( ! wp_next_scheduled( 'woofunnels_wfob_license_check' ) ) {
			wp_schedule_event( time(), 'daily', 'woofunnels_wfob_license_check' );
		}
		add_action( 'woofunnels_wfob_license_check', array( $this, 'license_check' ) );
