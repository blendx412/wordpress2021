...
if ( class_exists( 'WooCommerce' ) ) { ?>
    <div class="wrap">
        <div class="wpwoof-wrap">
            <h1 class="wpwoof-heading">Product Catalog Pro by PixelYourSite<br> <span class="wpwoof-sub-heading">WooCommerce Facebook Dynamic Product Ads Catalog Feed</span> <br></h1>
