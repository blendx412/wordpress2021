...
if ($options['displayQuantity'] == 'yes' && $product->get_type() != "variable") {
    ?>
...
?>	
    <section class="button">
        <a href="#" class="action-button">
            <?php echo $product->get_type() == "variable" ? _e($options['textChooseAnOption'], $id) : $product->single_add_to_cart_text(); ?>
        </a>
    </section>
<?php			
	} else {
