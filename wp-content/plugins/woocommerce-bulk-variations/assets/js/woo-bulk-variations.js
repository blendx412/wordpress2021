jQuery(document).ready(function() {
	...
	var _addRow = function(values) {
		...
		var $row = $wrapper.children('.wcbv-variations').append('<div class="wcbv-row wcbv-clearfix"><div class="variation-title">Proizvod 1</div><div class="wcbv-fields wcbv-clearfix"><div class="wcbv-selects wcbv-columns wcbv-two"></div></div><div class="wcbv-price"></div></div>').children('.wcbv-row:last'),
