...
class WFOCU_Admin_Refund {
	...
	public function wfocu_should_show_refund_metabox( $wc_get_order ) {
		...
		if ( is_object( $this->get_integration ) ) {
			...
			$result = $refund_supported && $gateway_enabled && ( ! empty( $wc_get_order->get_transaction_id() ) || 'wfocu_test' === $wc_get_order->get_payment_method() );
		}
	...
	public function print_metabox_css() {
        ...
        <style>
            ...
            #wfocu-offer-refund-metabox .woocommerce_order_items_wrapper table.woocommerce_order_items .quantity .view{white-space:normal}
