<div v-if="product.vars_count>0" class="have_variation">
	<?php _e( "Customize visibility & discounts per variant and choose a default variant.", 'woofunnels-upstroke-one-click-upsell' ) ?>
</div>
...
<table width="100%" class="variation_products" v-bind:data-index="index" v-if="product.vars_count>0" border="1">
    <thead>
    <tr>
        <th>
    ...
    <tr v-for="(variation, var_index) in product.variations" v-bind:id="variation.vid" class="product_variation_row">
        ...
        <td>
            <div class=" product_options">
                ...
                <br/>
                <p v-if="variation.hasOwnProperty('sale_price') && variation.sale_price != ''"><?php _e( 'Sale Price', 'woofunnels-upstroke-one-click-upsell' ); ?>: <span v-html="variation.sale_price"></span></p>
                <br v-if="variation.hasOwnProperty('sale_price') && variation.sale_price != ''"/>
