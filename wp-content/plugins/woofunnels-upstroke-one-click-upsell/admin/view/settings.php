<div class="wfocu_funnel_setting" id="wfocu_funnel_setting_vue">
    <div class="wfocu_funnel_setting_inner">
        ...
        <div class="wfocu-funnel-setting">
            <div class="wfocu-tabs-style-line wfocu-funnel-setting-tabs" role="tablist">
                <div class="wfocu-funnel-setting-tabs-wrapper wfocu-tab-center">

                    <div class="wfocu-tab-title wfocu-tab-setting-title basic_tab wfocu-active" id="tab-title-basic" data-tab="1" role="tab" aria-controls="wfocu-tab-content-basic">
						<?php _e( 'Settings', 'woofunnels-upstroke-one-click-upsell' ); ?>
                    </div>
                    <div class="wfocu-tab-title wfocu-tab-setting-title advanced " id="tab-title-advanced" data-tab="2" role="tab" aria-controls="wfocu-tab-content-description">
            ...
            <div class="wfocu-funnel-setting-tabs-content">
                <form class="wfocu_forms_wrap wfocu_forms_funnel_settings wfocu-content-tab data-content-tab-1">
                    <fieldset>
                        <vue-form-generator :schema="schema" :model="model" :options="formOptions">
                        </vue-form-generator>
                    </fieldset>
                </form>
                <div class="wfocu-content-tab data-content-tab-2 wfocu-funnel-advanced-settings" style="display: none;">
                    <div class="advanced_settings">
                        ...
                        <div class="wfocu_install_nextmove_wrap">
                            <div class="wfocu_setup_nextmove" v-if="nextMoveState == `ready_to_install` || nextMoveState == `ready_to_activate`">
                                ...
                                <button v-if="nextMoveState == `ready_to_install`" v-on:click="wfocu_next_move_process($event)" href="javascript:void(0)" data-slug="<?php echo $plugin_slug; ?>" class="wfocu_save_btn_style install-now " href="#">
                                    {{nextMoveCtaText}}
                                </button>
                                <button v-else v-on:click="activate_next_move_request(`<?php echo $plugin_slug; ?>`)" href="javascript:void(0)" data-slug="<?php echo $plugin_slug; ?>" class="wfocu_save_btn_style" href="#">
                                    {{nextMoveCtaText}}
                                </button>
                            ...
                            <div class="wfocu_nextmove_activated" v-if="nextMoveState == `ready_to_configure`">
                                ...
                                <a v-if="nextMoveInstallState == `1`" target="_blank" class="wfocu_save_btn_style" href="<?php echo esc_url( admin_url( 'post-new.php?post_type=xlwcty_thankyou' ) ); ?>"><?php _e( 'Add Thank you page', 'woofunnels-upstroke-one-click-upsell' ) ?></a>
                                <a v-else class="wfocu_save_btn_style" target="_blank" href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=xl-thank-you' ) ); ?>"><?php _e( 'Create a Thank You Page', 'woofunnels-upstroke-one-click-upsell' ) ?></a>
