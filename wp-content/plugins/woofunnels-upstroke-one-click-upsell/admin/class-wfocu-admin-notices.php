...
class WFOCU_Admin_Notices {
	...
	public function paypal_on_notice() {
        ...
        <div class="wfocu-notice notice notice-error">
            <p><?php _e( 'UpStroke Notice: For PayPal to work, Reference Transactions should be enabled for your PayPal Account. Learn how to get Reference Transactions enabled. <br/><br/> Note: If you don\'t have  Reference Transactions enabled for your accounts, UpStroke won\'t trigger funnels. Falsely, indicating enablement of Reference Transactions will lead to payment failures.', 'woofunnels-upstroke-one-click-upsell' ); ?>
	...
	public function paypal_creds_missing_notice() {
		?>
        <div class="wfocu-notice notice notice-error">
            <p><?php _e( 'UpStroke Notice: PayPal is inactive and upsell offers won\'t trigger. Please Add Username,Password and Signature in API Credentials section. Go to WooCommerce > Settings > Checkout > PayPal to add these credentials.', 'woofunnels-upstroke-one-click-upsell' ); ?> </p>
            <p>
	...
	public function pys_notice() {
		?>
        <div class="wfocu-notice notice notice-error">
            <p><?php _e( 'UpStroke Notice: We notice that you are using PixelYourSite. To avoid duplication of purchase events, <strong>disable the Purchase Event </strong> from PixelYourSite and enable it from UpStroke. Go to Global Settings > Tracking & Analytics.', 'woofunnels-upstroke-one-click-upsell' ); ?>
            ...
            <p>
                <a href="<?php echo admin_url( 'admin.php?page=upstroke&tab=settings' ); ?>" class="button"><?php _e( 'Go to settings', 'woofunnels-upstroke-one-click-upsell' ); ?></a>
                <a style="padding-left: 10px;" href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=upstroke&tab=settings&nid=pys' ), 'wfocu_dismissed_notice' ); ?>" class=""><?php _e( 'Ignore this message', 'woofunnels-upstroke-one-click-upsell' ); ?></a>
            </p>
        </div>
		<?php
	}
