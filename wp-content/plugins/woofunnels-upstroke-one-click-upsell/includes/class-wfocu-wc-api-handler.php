...
class WFOCU_WC_API_Handler {
	...
	public function get_api_actions() {
		return array( 'api_health_check', 'offer_expiry', 'end_funnel' );
	}
	...
	public function offer_expiry() {
		...
		if ( ( isset( $_GET['log_event'] ) && 'no' === $_GET['log_event'] ) ) {  // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
