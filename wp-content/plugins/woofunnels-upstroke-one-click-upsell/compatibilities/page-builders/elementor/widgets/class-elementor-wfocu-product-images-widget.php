	...
	public function render() {
		...
		if ( isset( $settings['selected_product'] ) && ! empty( $settings['selected_product'] ) ) {
			...
			if ( $product_obj instanceof WC_Product ) {
                ...
                <link rel="stylesheet" id="flickity-css" href="<?php echo plugins_url(); ?>/woofunnels-upstroke-one-click-upsell/assets/flickity/flickity.css" type="text/css" media="all">
                <link rel="stylesheet" id="flickity-common-css" href="<?php echo plugins_url(); ?>/woofunnels-upstroke-one-click-upsell/assets/css/flickity-common.css" type="text/css" media="all">
				<?php
				if ( ! empty( $main_img ) ) {
