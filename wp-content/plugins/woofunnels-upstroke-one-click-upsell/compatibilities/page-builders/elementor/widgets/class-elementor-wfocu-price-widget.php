	...
	protected function _register_controls() {
		...
		$this->add_responsive_control( 'sale_price_spacing', [
			...
			'selectors'   => [
				...
				'{{WRAPPER}} .elementor-price-wrapper .offer_wrapper .wfocu-offer-label, {{WRAPPER}} .elementor-price-wrapper .offer_wrapper .wfocu-sale-price span' => 'font-size: 24px; font-weight: 400; font-family:  "Open Sans",sans-serif;',
				'body[data-elementor-device-mode="mobile"] {{WRAPPER}} .elementor-price-wrapper .offer_wrapper .amount'                                              => 'font-size: 24px; font-family:  "Open Sans",sans-serif;',
				'body[data-elementor-device-mode="mobile"] {{WRAPPER}} .elementor-price-wrapper .offer_wrapper .wfocu-offer-label'                                   => 'font-size: 20px; font-family:  "Open Sans",sans-serif;',
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'selector'  => '.single-wfocu_offer {{WRAPPER}} .elementor-price-wrapper .wfocu-reg-label',
			'condition' => [
				'show_reg_price' => 'yes',
			],
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'scheme'    => Scheme_Typography::TYPOGRAPHY_1,
			'selector'  => '.single-wfocu_offer {{WRAPPER}} .elementor-price-wrapper .reg_wrapper strike span',
			'condition' => [
				'show_reg_price' => 'yes',
			],
		] );
		...
		$this->add_control( 'price_color', [
			'label'     => __( 'Price Color', 'elementor-pro' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '#8d8e92',
			'scheme'    => [
				'type'  => Scheme_Color::get_type(),
		...
		$this->add_control( 'offer_heading', [
			'label'     => __( 'Offer Price', 'elementor-pro' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'     => 'Label Typography',
			'scheme'    => Scheme_Typography::TYPOGRAPHY_1,
			'selector'  => '.single-wfocu_offer {{WRAPPER}} .elementor-price-wrapper .wfocu-offer-label',
			'condition' => [
				'show_offer_price' => 'yes',
			],
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'     => 'Price Typography',
			'scheme'    => Scheme_Typography::TYPOGRAPHY_1,
			'selector'  => '.single-wfocu_offer {{WRAPPER}} .elementor-price-wrapper .wfocu-sale-price span',
			'condition' => [
				'show_offer_price' => 'yes',
			],
		] );
		...
		$this->add_control( 'signup_fee_heading', [
			'label'     => __( 'Signup Fee', 'elementor-pro' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [
		...
		$this->add_control( 'rec_price_heading', [
			'label'     => __( 'Recurring Price', 'elementor-pro' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [
				'selected_product' => $subscriptions,
