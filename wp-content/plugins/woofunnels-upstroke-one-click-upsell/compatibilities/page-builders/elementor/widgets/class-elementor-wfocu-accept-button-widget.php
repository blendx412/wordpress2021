...
class Elementor_WFOCU_Accept_Button_Widget extends \Elementor\Widget_Button {
	...
	protected function _register_controls() {
		...
		$this->add_control( 'text_spacing', [
			'label'      => __( 'Spacing between Title and Subtitle', 'elementor-pro' ),
			...
			'selectors'  => [
				'.woocommerce-active {{WRAPPER}} .elementor-button .elementor-button-text' => 'margin-bottom: {{SIZE}}{{UNIT}}',
			],
		] );
		...
		$this->start_controls_section( 'section_style', [
			'label' => __( 'Accept Offer', 'elementor' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [
			...
			'selector' => '{{WRAPPER}} .elementor-button .elementor-button-text, {{WRAPPER}} .elementor-button .elementor-button-icon',
		] );
		...
		$this->add_control( 'button_subtitle_color', [
			'label'     => __( 'Subtitle Text Color', 'elementor' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '#fff',
			'selectors' => [
