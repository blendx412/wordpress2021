...
class Elementor_WFOCU_Variation_Selector_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control( 'align', [
			...
			'selectors'      => [
				'{{WRAPPER}} .variations td.value, {{WRAPPER}} .variations td.label, {{WRAPPER}}.elementor-attr_value-block-yes .variations tr' => 'text-align: {{VALUE}};',
			],
			'condition'      => [
				'selected_product' => $variables,
			],
		...
		$this->add_responsive_control( 'attr_value_width', [
			...
			'selectors'  => [
				...
				'{{WRAPPER}} .variations .value select, body[data-elementor-device-mode="desktop"] {{WRAPPER}}.elementor-attr_value-block-yes.elementor-align-center .variations .label, body[data-elementor-device-mode="mobile"] {{WRAPPER}}.elementor-attr_value-block-yes.elementor-mobile-align-center .variations .label,  body[data-elementor-device-mode="tablet"] {{WRAPPER}}.elementor-attr_value-block-yes.elementor-tablet-align-center .variations .label' => 'width: {{SIZE}}{{UNIT}}; text-align: left; margin: auto; display: inline-block',
