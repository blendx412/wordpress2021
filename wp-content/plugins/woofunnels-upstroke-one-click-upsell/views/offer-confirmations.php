...
if ( ! empty( $template_group ) && $template_group instanceof WFOCU_Template_Group_Customizer ) {
	...
	$template_ins->internal_css['offer_confirm_yes_color']           = array();
	$template_ins->internal_css['offer_confirm_yes_color']['hover']  = array();
	$template_ins->internal_css['offer_confirm_yes_color']['bg']     = WFOCU_Core()->data->get_option( 'offer_yes_btn_bg_cl' );
	$template_ins->internal_css['offer_confirm_yes_color']['shadow'] = WFOCU_Core()->data->get_option( 'offer_yes_btn_sh_cl' );
	$template_ins->internal_css['offer_confirm_yes_color']['text']   = WFOCU_Core()->data->get_option( 'offer_yes_btn_txt_cl' );

	$template_ins->internal_css['offer_confirm_yes_color']['hover']['bg']     = WFOCU_Core()->data->get_option( 'offer_yes_btn_bg_cl_h' );
	$template_ins->internal_css['offer_confirm_yes_color']['hover']['shadow'] = WFOCU_Core()->data->get_option( 'offer_yes_btn_sh_cl_h' );
	$template_ins->internal_css['offer_confirm_yes_color']['hover']['text']   = WFOCU_Core()->data->get_option( 'offer_yes_btn_txt_cl_h' );


	$template_ins->internal_css['offer_confirm_no_color']       = WFOCU_Core()->data->get_option( 'offer_no_btn_txt_cl' );
	$template_ins->internal_css['offer_confirm_no_color_hover'] = WFOCU_Core()->data->get_option( 'offer_no_btn_txt_cl_h' );


	$template_ins->internal_css['cart_opener']            = WFOCU_Core()->data->get_option( 'cart_opener_background_color' );
	$template_ins->internal_css['cart_opener_text_color'] = WFOCU_Core()->data->get_option( 'cart_opener_text_color' );
...
<script type="text/html" id="tmpl-wfocu-bucket-template">
    <div class="wfocu-sidecart-content">
        <div class="wfocu-mc-loader">
            <img src="<?php echo WFOCU_PLUGIN_URL; ?>/assets/img/mc-spinner.gif" alt="" title=""/>
        </div>
                    ...
                    <div class="wfocu-item-info-btm wfocu-clearfix">
                        ...
                        <div class="wfocu-item-desc">
                            ...
                            <div class="wfocu-item-m ">
                                ...
                                <span class="wfocu-desc-m-val">{{decodeURIComponent(it.val)}}</span>
    ...
    <div class="wfocu-sidecart-footer-content">
        ...
        <div class="wfocu-sidecart-footer-bottom">
            <div class="wfocu-mc-footer-row wfocu-text-center">
                <div class="wfocu-mc-footer-btn ">
                    <a href="javascript:void(0);" class="wfocu-mc-button" <?php $this->add_attributes_to_confirmation_button(); ?>><?php echo $yes_text; ?></a>
                </div>
        ...
        <# } else { #>
        <div class="wfocu-mc-empty-msg"><?php _e( 'No products found', 'woofunnels-upstroke-one-click-upsell' ); ?></div>
        <# } #>
    </div>
</script>
