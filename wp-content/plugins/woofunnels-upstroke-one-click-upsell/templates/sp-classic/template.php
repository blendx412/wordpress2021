					...
					'guarantee' => array(
						...
						'fields' => array(
							...
							'additional_text'    => array(
								...
								'label'           => __( 'Additional Text', 'woofunnels-upstroke-one-click-upsell' ),
								'description'     => $merge_tags_description,
								'default'         => esc_attr__( 'Got a guarantee or a solid return/refund policy? Highlight them all here to arrest your buyers’ last-minute objections. Reinforce the trust.', 'woofunnels-upstroke-one-click-upsell' ),
								'transport'       => 'postMessage',
								'wfocu_transport' => array(
									array(
										'type'       => 'html',
