...
<div class="wfocu-rules-builder woocommerce_options_panel" data-category="product">
	<?php /*?> <div class="wfocu_fsetting_table_head">
	    <div class="wfocu_fsetting_table_title "><?php _e( " Target Products", 'woofunnels-upstroke-one-click-upsell' ); ?></div>
    ...
    <div class="label">
        <h4><?php _e( "Target Products", 'woofunnels-upstroke-one-click-upsell' ); ?></h4>
    </div>
                ...
                <div class="wfocu-rule-group-container" data-groupid="<?php echo $group_id; ?>">
                    <div class="wfocu-rule-group-header">
						<?php if ( $group_counter == 0 ): ?>
                            <h4><?php _e( 'Initiate this funnel when these conditions are matched', 'woofunnels-upstroke-one-click-upsell' ); ?></h4>
						<?php else: ?>
