<?php
/**
 * Template Name: 1. Landing Page Builder
 *
...
<?php elseif( get_row_layout() == 'uvodna-nova' ): ?>
			...
			$addto = get_sub_field('dodaj_v_kosarico_tekst');
            ?>
    ...
    <section style="padding-left: 0;
    padding-right: 0;" class="section uvodna2 sticky-child top">
        <div class="container">
            <div class="columns">
                <div class="column is-12-mobile is-half is-marginless is-paddingless">
                ...
                <div class="column is-12-mobile is-half is-marginless is-paddingless">
                    <div class="wrapper">
                        <h2 style="padding-left: 00px;   padding-right: 10px;"><b><?php echo $tekst1; ?></b></h2>
                        <div style="margin: 10px 0 10px 0;"></div>
                        <div style="background: <?php echo $color1; ?> !important;" class="banner primary">
                            <span class="old"><?php echo $tekst2; ?>
</span>
					  ...
					  <a class="button-kupi green-button" href="<?php echo $domain; ?>/?add-to-cart=<?php echo $izdelek; ?>" data-text="">
                        <div class="button-kupi-inner " style="margin: 20px 26px;">
                            <i class="fas fa-shopping-cart" aria-hidden="true"></i>
                            <span class="button-kupi-text white-button"><?php echo $addto; ?></span>
                        </div>
                    </a>
 ...
 <?php elseif( get_row_layout() == 'nakupna2s' ): ?>
...
width: 50%;
 ...
 #nakup222 #getting-started2 span {
	...
	$barva_border_top = get_sub_field('barva_border_top');  
	$slika_22 = get_sub_field('slika_22');  
	
	$naslov = get_sub_field('naslov'); 
	$teskt = get_sub_field('teskt'); 
	$linija_1_tekst = get_sub_field('linija_1_tekst'); 
	$linija_2_tekst = get_sub_field('linija_2_tekst'); 
	$cena = get_sub_field('cena');

	$addto = get_sub_field('dodaj_v_kosarico_tekst2');
	$dostavat = get_sub_field('dostava_tekst');
	
	?>
			
<section style="margin-bottom: 0px; background: white;" id="nakup222">
        <div class="container">
		 <div class="columns">
		
            <div class="no-pad  column is-6 is-12-mobile ">
            ...
            <div style="border-top-color: <?php echo $barva_border_top; ?> !important;" class="nakupX column is-6 is-12-mobile">

                <div style="width: 150px; display: inline-box;">
				
                    <img src="<?php echo $slika_22; ?>" alt="">
					
                </div>

                <p class="pb-0" style="font-size: 1.4em; font-weight: 400;  "><b><?php echo $naslov; ?></b></p>
				
				
                    <p style="    font-size: 17px;"  class="mb-30 mt-10">
                        <?php echo $teskt; ?>
                    </p>
                    <p class="mb-5" style="font-size: 0.9em; margin: 0px 0px; color:rgb(27, 158, 22);"> 
					<i class="mr-5 fas fa-exclamation-circle" aria-hidden="true"></i> <?php echo $linija_1_tekst; ?></p>
                    <p class="mb-10" style="font-size: 0.9em; margin: 0px 0px; color:rgb(27, 158, 22);">
					<i class="mr-5 fas fa-check-circle" aria-hidden="true"></i>  <?php echo $linija_2_tekst; ?> </p>

                
                <div class="item-product-price pt-10 pb-30 mb-30" style="position: relative;font-size: 1.8em; justify-content: center;">
					
					<!--
                     <div class="price-num" style="color:rgb(102, 134, 133); position: relative; ">
                        14,99 €
                    </div>-->
					
                    <div class="mini-headline" style="font-weight: bold !important;font-size: 0.7em; color: #273445; justify-content: center;">
                        <?php echo $cena; ?>
                    </div>
                </div>
								...
								<div id="getting-started2"> <span> dni </span><span> ur </span><span> minut </span><span> sekund </span></div>
           
                

                <div class="grid-half-2 grid-row-2 grid-left button-kosara pt-10">
                    <a class="button-kupi green-button" href="<?php echo $domain; ?>/?add-to-cart=<?php echo $izdelek; ?>" data-text="">
                        <div class="button-kupi-inner " style="margin: 20px 26px;">
                            <i class="fas fa-shopping-cart" aria-hidden="true"></i>
                            <span class="button-kupi-text white-button"><?php echo $addto; ?></span>
                ...
                <div class="wrapper22" style="display: flex; justify-content: center;">

                <div class="payment-methods">
                            <div class="payments">
                                <img src="https://mistermega.si/wp-content/uploads/2020/01/payment-pl.png">
                            </div>
                            <div class="sender hoverly hover-parent" data-pos="bottom" data-delivery="true" data-size="medium">
                                <div><img src="https://mistermega.si/wp-content/uploads/2020/01/gls-logo.png"></div>
                                <span><?php echo $dostavat; ?></span>
                            </div>
                        </div>
