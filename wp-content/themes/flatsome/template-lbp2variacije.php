<?php
/**
 * Template Name: 2. Landing Page Builder VARIACIJE
 *
                        ...
                        <div class="buy-wrapper">
                            <div class='custom_qty'>
								...
								?>
								   ...
								   <div id="izdelek1" class="izdelek1 q_act">
									   <table>
										<tr>
										<?php $c = 0; ?>
								...
								<div id="izdelek2" style="display: none;" class="izdelek2">
								 ...
								 <div  id="izdelek3" style="display: none;"  class="izdelek3">
     ...
     return false;
  	...
  	$('#order_link' ).click(function (e) {
		...
		$('.product_qty2' ).click(function (e) { 
				...
				//$.ajax({url: base, success: function(result){
